...
Four ways of looking at the same underlying question -- does someone have a
color vision deficiency, and if so, which kind:
...
- **Solid and ready to lean on:** behavioral group separation (especially
  ...
  and the spatial agreement between clicks and EEG response.
- **Promising but not yet proven:** whether EEG severity tracks behavioral
  severity person-by-person -- a real, honestly-documented open question,
  not a dead end.
- **Not yet started:** connecting FM100 to the behavioral and EEG data
  directly -- the piece you've flagged as the most pressing next step.
